...
$stmt = $pdo->prepare('SELECT email FROM contatos ORDER BY email OFFSET :offset LIMIT :limit');
        ...
        <tbody>
            <?php foreach ($contacts as $contact) : ?>
                <tr>
                    <td><?= $contact['email'] ?></td>
                    <td class="actions">
                        <a href="update.php?id=<?= $contact['email'] ?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                        <a href="delete.php?id=<?= $contact['email'] ?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
