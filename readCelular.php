...
$stmt = $pdo->prepare('SELECT cel FROM contatos ORDER BY cel OFFSET :offset LIMIT :limit');
        ...
        <tbody>
            <?php foreach ($contacts as $contact) : ?>
                <tr>
                    <td><?= $contact['cel'] ?></td>
                    <td class="actions">
                        <a href="update.php?id=<?= $contact['cel'] ?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                        <a href="delete.php?id=<?= $contact['cel'] ?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
